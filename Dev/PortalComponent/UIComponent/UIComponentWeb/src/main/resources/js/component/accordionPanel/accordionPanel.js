...
function default_accordionpanel_DomStruFn(conf){
	...
	temp.autoInnerHeight = conf.autoInnerHeight;
}
...
function defatul_accordionpanel_DomCtrlFn(conf){
	...
	temp.isExpend = function(){
		return temp.$accContent.attr("state") === "expend";
	};
	
	temp.setContentHeight = function(height){
		temp.$accContent.attr("height",height);
	}
	
	temp.getContentHeight = function(){
		var height = temp.$accContent.attr("height");
	...
	temp.clearHeight = function(){
		temp.$accContent.css("height","auto");
		temp.$accContent.removeAttr("height");
	}
}
