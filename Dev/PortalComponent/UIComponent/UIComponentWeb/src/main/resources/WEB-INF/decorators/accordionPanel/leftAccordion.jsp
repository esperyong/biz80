...
<div id="<decorator:getProperty property="id" />" style="width:<decorator:getProperty property="width"/>">
	...
	%>
		<div class="left-panel-<%=open %>" style="width:100%" dindex="<%=i %>">
			...
			<div class="left-panel-content" style="height:<%=height %>;display:block;" display="<%=display %>"  state="<%="collect".equals(display)?"collect":"expend"%>"><%=panel.getProperty("panelContent_"+i) %></div>
		</div>	
