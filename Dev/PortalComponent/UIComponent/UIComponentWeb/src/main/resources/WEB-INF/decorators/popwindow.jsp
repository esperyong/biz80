...
<div class="pop" style="width:<decorator:getProperty property="width" />;">
	<div class="pop-top-l">
		<div class="pop-top-r">
			...
			%>
				<a class="<%=p.getProperty("topBtn_css_" + i) %>" id="<%=p.getProperty("topBtn_id_" + i)%>" <%=title %>></a>
			  <%}%>
	...
	<div class="pop-m">
		<div class="pop-content" style="height:<decorator:getProperty property="height" />;<decorator:getProperty property="style" />" >
	...
	<div class="pop-bottom-l">
		<div class="pop-bottom-r">
			...
			<%if( bblist != null && !bblist.isEmpty()) {%>
			   ...
			   <span id="<%=p.getProperty("bottomBtn_id_" + (bblist.size()-i)) %>" class="win-button">
				   <span class="win-button-border">
				   <a><%=p.getProperty("bottomBtn_text_" +  (bblist.size()-i)) %></a></span>
			   </span>
			  <%}%>
			<%}	%>
			</div>
