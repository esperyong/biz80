/*
 * $Id: JsonLibHandlerTest.java 651946 2008-04-27 13:41:38Z apetrelli $
 *
...
import com.mocha.bsm.bizsm.struts2rest.handler.JsonLibHandler;
...
public class JsonLibHandlerTest extends TestCase {
    ...
    public void testToObject2() throws IOException {
        Contact contact = new Contact("bob", true, 44);

        Contact target = new Contact();
        StringReader reader = new StringReader("[\"Sunday\", \"Monday\", \"Tuesday\", \"Wednesday\", \"Thursday\", \"Friday\", \"Saturday\"]");
        JsonLibHandler handler = new JsonLibHandler();
        handler.toObject(reader, target);
