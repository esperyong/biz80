...
import com.mocha.bsm.bizsm.struts2rest.RestWorkflowInterceptor;
...
public class RestWorkflowInterceptorTest extends TestCase {
    ...
    public void testCustomValidationFailureStatusCode() throws Exception {
        ...
        Mock mockContentTypeHandlerManager = new Mock(IContentTypeHandlerManager.class);
        ...
        wf.setContentTypeHandlerManager((IContentTypeHandlerManager) mockContentTypeHandlerManager.proxy());
