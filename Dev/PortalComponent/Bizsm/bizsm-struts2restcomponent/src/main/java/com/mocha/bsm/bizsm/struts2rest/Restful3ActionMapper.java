 ...
 *  <li><code>POST:    /movie/               => method="createSubResource"</code></li>
 *  <li><code>POST:    /movie/Thrillers      => method="appendData", id="Thrillers"</code></li>
 *  <li><code>PUT:     /movie/Thrillers      => method="createOrUpdate", id="Thrillers"</code></li>
 *  <li><code>PUT:     /movie/               => method="createOrUpdateStructure"</code></li>
 *  <li><code>DELETE:  /movie/Thrillers      => method="remove", id="Thrillers"</code></li>
 *  <li><code>HEAD:    /movie/Thrillers      => method="viewMeta", id="Thrillers"</code></li>
 * </ul>
 * <p>
...
public class Restful3ActionMapper extends DefaultActionMapper {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(Restful3ActionMapper.class);
    ...
    public Restful3ActionMapper() {
    	...
    	setAlwaysSelectFullNamespace("false");
    }
    
    protected boolean isAlwaysSelectFullNamespace(){
    	return this.alwaysSelectFullNamespace;
    }
    ...
    */
    public ActionMapping getMapping(HttpServletRequest request, ConfigurationManager configManager) {
    	...
    	if(this.isAlwaysSelectFullNamespace()){
    		throw new IllegalStateException("This action mapper requires the setting constant 'struts.mapper.alwaysSelectFullNamespace' to be set to 'false'");
    	}
        ...
        if (actionName != null && actionName.length() > 0) {
            ...
            if (mapping.getMethod() == null) {
            	//if '/' is the last char in the actionName
                if (lastSlashPos == actionName.length() -1) {
                    ...
                    // Creating a new entry on POST e.g. foo/
                    	...
                    	mapping.setMethod("createOrUpdateStructure");
                    } else if (isPost(request)) {
                        mapping.setMethod("createSubResource");
                        
                    } else if(this.isHEAD(request)){
                    	mapping.setMethod("viewStructureMeta");
                    	
                    } else if(this.isOPTIONS(request)){
                    	mapping.setMethod("viewResourcesOperations");	
                    } 
                    
                //if '/' is not the last char in the actionName
                    ...
                    // Updating an item e.g. foo/1    
                        ...
                        mapping.setMethod("createOrUpdate");
                        
                    // create an subitem in the item e.g. foo/1 add by liuyong
                    }  else if (isPost(request)) {
                        mapping.setMethod("appendData");
                        
                    }  else if(this.isHEAD(request)){
                    	mapping.setMethod("viewMeta");
                    	
                    }  else if(this.isOPTIONS(request)){
                    	mapping.setMethod("viewResourceOperations");
    ...
    protected boolean isHEAD(HttpServletRequest request) {
        if ("head".equalsIgnoreCase(request.getMethod())) {
            return true;
        } else {
            return isPost(request) && "head".equalsIgnoreCase(request.getParameter(HTTP_METHOD_PARAM));
        }
    }  
    ...
    protected boolean isOPTIONS(HttpServletRequest request) {
        if ("options".equalsIgnoreCase(request.getMethod())) {
            ...
            return isPost(request) && "options".equalsIgnoreCase(request.getParameter(HTTP_METHOD_PARAM));
        }
    }
