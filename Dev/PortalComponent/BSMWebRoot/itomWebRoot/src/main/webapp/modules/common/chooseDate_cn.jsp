   ...
   rqre.encoding("UTF-8").nocache().security();
    ...
    String riqi="", shijian="", nian="", yue="", ri="", shi="", fen="", miao="";
     if(!"".equals(riqishijian) && riqishijian!=null){
      ...
      nian=riqi.substring(0,4);
      yue =riqi.substring(5,7);
	  ri  =riqi.substring(8,10);
...
function fDrawCal(iYear, iMonth, iCellHeight, sDateTextSize) {
  var WeekDay = new Array("<font color='red'>日</font>","一","二","三","四","五","六");
...
write("<div style='color:black; font-size:12px'>时间: ");
...
write("<div style='color:black;cursor:hand; font-size:12px' onclick='fSetDate(giYear,giMonth,giDay)' onMouseOver=\"this.style.color='#8B0000'\" onMouseOut='this.style.color=gdBG'>选择: <font face='tahoma'>"+giYear+"/"+giMonth+"/"+giDay+"</font></div>");
write("</td><td width='18%' align='center'>");
write("<div ID=\"CAL_B_OK\" style='color:#ff2521; visibility:visible; cursor:hand; font-size:12px' onclick='OK()' onMouseOver=\"this.style.color='#8B0000'\" onMouseOut=\"this.style.color='#ff2521'\">确定</div>");
write("</td><td width='18%' align='left'>");
write("<div ID=\"CAL_B_BLANK\" style='color:#ff2521; visibility:visible; cursor:hand; font-size:12px' onclick='cancel()' onMouseOver=\"this.style.color='#8B0000'\" onMouseOut=\"this.style.color='#ff2521'\">清空</div>");
write("</td></tr>");
write("</table>");
write("</TD></TR>");
write("</TABLE>");
