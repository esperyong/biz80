    ...
    <td valign="top"><table width="884" cellpadding="0" cellspacing="0">
      <tr>
            ...
            <td background="${ctx}/images/navigation/guide-nav-bg.gif"><table width="175" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="175" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td><a href="bizservicedefine2.jsp" onmouseover="MM_swapImage('step02','','${ctx}/images/navigation/bizservice-step-02-on.jpg',1)" onmouseout="MM_swapImgRestore()"><img src="${ctx}/images/navigation/bizservice-step-02-on.jpg" name="step02" width="175" height="55" border="0" id="step02" /></a></td>
                  </tr>
                  <tr>
                    <td height="15"></td>
                  </tr>
        ...
        <td width="699" valign="top" bgcolor="#FFFFFF"><table width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td width="100%" height="30" background="${ctx}/images/navigation/xiala01.jpg"><strong>&nbsp; 第二步：定义业务服务结构</strong></td>
          </tr>
        </table>
              <table width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="100%" align="center" valign="top"><table width="99%" cellpadding="6" cellspacing="0">
                    ...
                    <tr>
                      <td colspan="2" align="left" valign="top">1.从绘图栏拖拽‘子业务服务’、‘资源’、‘业务单位’和‘自定义元素’的图标摆放到画布上，完成业务服务结构的定义。</td>
                    </tr>
                    <tr>
                      <td align="left" valign="top">&nbsp;</td>
                      <td align="left" valign="top"><img src="${ctx}/images/navigation/help-setup.jpg" width="357" height="466" /></td>
                    </tr>
                    <tr>
                      <td colspan="2" align="left" valign="top">2.定义完成后点击工具栏中的保存按钮。</td>
                    </tr>
                    <tr>
                      <td width="100%" colspan="2" align="left" valign="top"><img src="${ctx}/images/navigation/help-save.jpg" width="693" height="54" /></td>
                    </tr>
