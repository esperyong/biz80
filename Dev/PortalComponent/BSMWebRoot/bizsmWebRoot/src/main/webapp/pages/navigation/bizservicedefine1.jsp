...
<title>bsm8.0</title>
<link href="${ctx}/css/bizsm-nav.css" rel="stylesheet" type="text/css" />
...
<body onload="MM_preloadImages('${ctx}/images/navigation/fx0101.jpg','${ctx}/images/navigation/fx0102.jpg','${ctx}/images/navigation/fx0103.jpg','${ctx}/images/navigation/fx0104.jpg','${ctx}/images/navigation/fx0105.jpg','${ctx}/images/navigation/guide-nav-step-01-on.gif','${ctx}/images/navigation/guide-nav-step-02-on.gif','${ctx}/images/navigation/guide-nav-step-03-on.gif','${ctx}/images/navigation/guide-nav-step-04-on.gif','${ctx}/images/navigation/bizservice-step-05-on.jpg')" scroll="auto" style="text-align:left;margin:0;">
  ...
  <tr>
    ...
    <td valign="top"><table width="884" cellpadding="0" cellspacing="0">
      <tr>
            ...
            <td background="${ctx}/images/navigation/guide-nav-bg.gif"><table width="175" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="175" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><a href="bizservicedefine1.jsp" onmouseover="MM_swapImage('step01','','${ctx}/images/navigation/bizservice-step-01-on.jpg',1)" onmouseout="MM_swapImgRestore()"><img src="${ctx}/images/navigation/bizservice-step-01-on.jpg" name="step01" width="175" height="55" border="0" id="step01" /></a></td>
                  </tr>
                  <tr>
                    <td height="15"></td>
                  </tr>
                  ...
                  <tr>
                    <td><a href="bizservicedefine4.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('step04','','${ctx}/images/navigation/bizservice-step-04-on.jpg',1)"><img src="${ctx}/images/navigation/bizservice-step-04-off.jpg" name="step04" width="175" height="55" border="0" id="step04" /></a></td>
                  </tr>
                  <tr>
                    <td height="15"></td>
                  </tr>
        ...
        <td width="699" valign="top" style="vertical-align:top" bgcolor="#FFFFFF">
		<table width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td width="100%" height="30" background="${ctx}/images/navigation/xiala01.jpg"><strong>&nbsp; 第一步：新建业务服务</strong></td>
          </tr>
        </table>
          <table width="100%" cellspacing="0" cellpadding="0">
            <tr>
              <td width="100%" align="center" valign="top"><table width="99%" cellpadding="6" cellspacing="0">
                    <tr>
                      <td colspan="2" align="left">点击业务服务定义左侧导航栏中的‘<img src="${ctx}/images/navigation/add-button1.gif" width="10" height="10" hspace="5" />  ’创建业务服务。</td>
                    </tr>
                    <tr>
                      <td width="4%" align="left" valign="top">&nbsp;</td>
                      <td width="96%" align="left" valign="top"><img src="${ctx}/images/navigation/guide-step-02-pic-02.jpg" width="206" height="108" /></td>
                    </tr>
                    <tr>
