    ...
    <td valign="top"><table width="884" cellpadding="0" cellspacing="0">
      <tr>
            ...
            <td background="${ctx}/images/navigation/guide-nav-bg.gif"><table width="175" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="175" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td><a href="bizservicedefine3.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('step03','','${ctx}/images/navigation/bizservice-step-03-on.jpg',1)"><img src="${ctx}/images/navigation/bizservice-step-03-on.jpg" name="step03" width="175" height="55" border="0" id="step03" /></a></td>
                  </tr>
                  <tr>
                    <td height="15"></td>
                  </tr>
        ...
        <td width="699" valign="top" bgcolor="#FFFFFF"><table width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td width="100%" height="30" background="${ctx}/images/navigation/xiala01.jpg"><strong>&nbsp; 第三步：业务服务状态定义</strong></td>
          </tr>
        </table>
              <table width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="30" colspan="2" align="center" valign="middle"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在‘状态定义’页面设置业务服务的状态规则。</div></td>
                </tr>
                <tr>
                  <td height="30" colspan="2" align="center" valign="top"><div align="left"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A</strong>. 系统默认规则：通过业务服务结构中的子服务和资源，自动计算状态。不能编辑。 </div></td>
                </tr>
                <tr>
                  <td width="3%" align="center" valign="top">&nbsp;</td>
                  <td width="97%" align="center" valign="top"><img src="${ctx}/images/navigation/help-status-default.jpg" width="675" height="330" /></td>
                </tr>
                ...
                <tr>
                  <td height="30" colspan="2" align="center" valign="top"><div align="left"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;B</strong>. 自定义规则：用户可以根据自己的需要手动创建规则。 </div></td>
                </tr>
                <tr>
                  <td align="center" valign="top"><div align="left"></div></td>
                  <td align="center" valign="top"><img src="${ctx}/images/navigation/help-status-free.jpg" width="675" height="387" /></td>
                </tr>
            </table>
            </td>
      </tr>
