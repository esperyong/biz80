  ...
  <tr>
    ...
    <td valign="top"><table width="884" cellpadding="0" cellspacing="0">
      <tr>
            ...
            <td background="${ctx}/images/navigation/guide-nav-bg.gif"><table width="175" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="175" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td><a href="bizservicedefine5.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('step05','','${ctx}/images/navigation/bizservice-step-05-on.jpg',1)"><img src="${ctx}/images/navigation/bizservice-step-05-on.jpg" name="step05" width="175" height="55" border="0" id="step05" /></a></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
        ...
        <td width="699" valign="top"  style="vertical-align:top" bgcolor="#FFFFFF"><table width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td width="100%" height="30" background="${ctx}/images/navigation/xiala01.jpg"><strong>&nbsp; 第五步：启用/禁用</strong></td>
          </tr>
        </table>
              <table width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="100%" align="center" valign="top"><table width="99%" border="0" cellspacing="0" cellpadding="6">

                        <tr>
                          <td colspan="2" align="left"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;以上步骤都创建完毕后，需要将业务服务启用。启用：监控业务服务，展现状态灯，根本原因等。禁用：编辑业务服务，不展现状态</td>
                        </tr>
                        <tr>
                          <td colspan="2" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;点击业务服务名称后的<img src="${ctx}/images/navigation/jiantou.jpg" width="17" height="16" />，启用或者禁用业务服务。</td>
                        </tr>
                        <tr>
                          <td width="4%" align="left">&nbsp;</td>
                          <td width="96%" align="left"><img src="${ctx}/images/navigation/help-qiyong.jpg" width="248" height="179" /></td>
                        </tr>
                        <tr>
