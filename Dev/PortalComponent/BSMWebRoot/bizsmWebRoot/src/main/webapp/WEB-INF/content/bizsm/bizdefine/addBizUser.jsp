...
var message = "";
	$(function() {
		...
		$('#execBtnForIPAddArea').bind("click",function(){
...
<form id="newForm">
<div class="pop" style="width:520px,height:284px">
	<div class="pop-top-l">
		<div class="pop-top-r">
			<div class="pop-top-m">
				<a id="closeIcon" class="win-ico win-close"></a>
				<span class="pop-top-title">新建业务单位</span>
			</div>
		</div>
	</div>
	...
	<div class="pop-m">
		<div class="pop-content">
			...
			<ul class="fieldlist-n">
				<li><span class="field" style="width:60px">业务单位</span><span>：</span><input type="text" id="bizName_txt" class="validate[required[业务单位],length[0,50,服务名称],noSpecialStr[服务名称]]" value="" /><span class="red">*</span></li>
				<li><span class="field" style="width:60px">图标</span><span>：</span>
					<img id="bizUserImg-img" uri="/folder/bizsm-model-icon/image/default-bizuser" src="${ctx}/folder/bizsm-model-icon/image/default-bizuser" width="40" height="33"/>
