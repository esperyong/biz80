...
<script type="text/javascript">
	var FontSizePanel = function(){
		...
		return {
			...
			show:function(){
				// fontsizePanel为字体panel的ID,通过回调方法绑定隐藏字体panel的方法      
				$('#fontsizePanel').show(1, function(){
			...
			setFontNumber:function(fontSize){
				try{	
					$('#btn-font-size a').text(fontSize);
				}catch(e){}	
			}
		};
	}();
