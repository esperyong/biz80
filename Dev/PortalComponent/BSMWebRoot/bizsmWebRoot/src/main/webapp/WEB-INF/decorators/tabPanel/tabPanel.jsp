 ...
 <div  class="<%=cls %>" style="width:<%=width %>">
	 <div class="tab-mid" style="width:<%=tabBarWidth %>">
    	 	<div class="tab-foot">
				...
				%>
      				<li <%=currentCls %> id="<%=jsonObject.get("id") %>">
      					<div class="tab-l">
      						<div class="tab-r">
      							<div class="tab-m">
	...
	%>
	 ...
	 %>
	 	<span class="black-btn-l" id="<%=jo.get("id") %>"><span class="btn-r"><span class="btn-m"><a><%=jo.get("text") %></a></span></span></span>
	 <%
	 		}
	 	}
	 ...
	 %>
		<div class="f-right tab-btn" ><span class="<%=jo.get("ico") %>"></span><a id="<%=jo.get("id") %>"><%=jo.get("text") %></a></div>	 
	 <%
	 		}
	 	}
