...
<script src="<%=request.getContextPath()%>/js/component/popwin.js" type="text/javascript"></script>

<script type="text/javascript" src="<%=request.getContextPath()%>/js/bizservice/ajaxcommon.js"></script>

<script>
var confirmConfig = {width: 450,height: 130};
$(function(){
...
function createB1(resId, dataTd, rowSize, ruleType, selArrayObj) {
	...
	var option4 = $('<option value="AVAILABLE_PERFSERIOUS">可用但性能严重超标或组件不可用</option>');
	var option5 = $('<option value="AVAILABLE_PERFMINOR">可用但性能轻微超标</option>');
	var option6 = $('<option value="AVAILABLE_PERFUNKNOWN">可用但性能未知或组件性能未知</option>');
...
function createE1(resId, comId, dataTd, rowSize, ruleType, selArrayObj){
	...
	var option2 = $('<option value="UNAVAILABLE">不可用</option>');
	var option3 = $('<option value="AVAILUNKNOWN">可用性未知</option>');
	var option4 = $('<option value="AVAILABLE_PERFSERIOUS">可用但性能严重超标</option>');
	var option5 = $('<option value="AVAILABLE_PERFMINOR">可用但性能轻微超标</option>');
	var option6 = $('<option value="AVAILABLE_PERFUNKNOWN">可用但性能未知</option>');
...
<div class="pop" style="width:800px;height:700px">
  <div class="pop-top-l">
    <div class="pop-top-r">
