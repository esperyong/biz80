...
function ctrl_param(obj)
{
    ...
    openWin("http://<%=ip%>/configure.html", 850, 620);
}
  ...
  <TR>
    ...
    <TD>
      <TABLE height=597 cellSpacing=0 cellPadding=0 width=215 border=0 background="${ctx}/images/room/video/main.jpg">
        ...
        <TR>
          <TD height=35><INPUT id=tcp type=radio CHECKED value=3 name=linktype> <LABEL for=tcp><B><s:text name="roommonitor.video.TCP" /></B></LABEL>
        ...
        <TR style='display:<%=display %>'>
          <TD height=90>
            <TABLE height="100%" cellSpacing=4 cellPadding=0 border=0>
              <TBODY>
              <TR valign='top'>
                <TD bgcolor="#EEEEEE"><?import namespace ="sn" implementation = "${ctx}/video/sn_bt.htc" />
          ...
          <TD height=60>
            <TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD>&nbsp;</TD></TR>
              <TR>
                <TD colSpan=3><?import namespace = "sn" implementation = "${ctx}/video/2k3Slider.htc" /><sn:2k3Slider id="mySlider" value="10"
