...
<head>
  ...
  <style type="text/css"> 
    span.elli-name{width:140px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
    ...
    span.elli-response{width:130px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
  ...
  <div class="padding8" >
    <ul>
      ...
      <li style="width:400px;" class="left">
        ...
        <select id="searchKey" name="searchKey" class="sb-line">
          ...
          <option value="PingIPAddress" <s:if test="'PingIPAddress'==searchKey">selected</s:if>><s:text name="detail.typical.pingaddress" /></option>
        </select>
    ...
    <table id="detailTab" class="tongji-grid table-width100 grayborder" style="border:1px solic #ccc;margin-top:5px;">
      <tr>
        ...
        <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.pingaddress" /> </span></th>
      ...
      <tr class="line" <s:if test="#idx.isEven()">style="background-color:#f2f2f2;"</s:if>>
        ...
        <td>
          <s:generator val="#dataMap['PingIPAddress']['metricValue']" separator="," var="iplist"></s:generator>
          <s:generator val="#dataMap['PingIPAddress']['metricValue']" separator="," var="iplist1"></s:generator>
          ...
          <s:if test="#iplistSize == 1">
            <s:property value="#dataMap['PingIPAddress']['metricValue']" default="-" />
          </s:if>
        ...
        <td><span class="elli-response" title="<s:property value="#dataMap['PingResponseTime']['metricValue']" default="-" />"><s:property value="#dataMap['PingResponseTime']['metricValue']" default="-" /></span></td>
