...
<head>
  ...
  <style type="text/css"> 
    ...
    span.elli-profile{width:100px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
  ...
  <!-- content start -->
    ...
    <ul>
			...
			<li style="width:400px;" class="left">
			  ...
			  <select id="searchKey" name="searchKey" class="sb-line"><option value="name" <s:if test="'name'==searchKey">selected</s:if>><s:text name="detail.typical.displayname" /></option><option value="DNSIPAddress" <s:if test="'DNSIPAddress'==searchKey">selected</s:if>><s:text name="detail.typical.dnsserveripaddress" /></option></select>
		...
		<table id="detailTab" class="tongji-grid table-width100 grayborder" style="border:1px solic #ccc;margin-top:5px;">
			<tr>
			  ...
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.dnsserveripaddress" /></span></th>
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.stratgy" /></span></th>
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.DNParsingResponseTime" /></span></th>
      ...
      <tr class="line" <s:if test="#idx.isEven()">style="background-color:#f2f2f2;"</s:if>>
        ...
        <td>
          <s:generator val="#dataMap['DNSIPAddress']['metricValue']" separator="," var="iplist"></s:generator>
          <s:generator val="#dataMap['DNSIPAddress']['metricValue']" separator="," var="iplist1"></s:generator>
          ...
          <s:if test="#iplistSize == 1">
            <s:property value="#dataMap['DNSIPAddress']['metricValue']" default="-" />
          </s:if>
        ...
        <td><s:property value="#dataMap['DNParsingResponseTime']['metricValue']" default="-" /></td>
