	...
	$(function() {
		...
		$('#execBtnForIPAddArea').click(function(){
			...
			if(modelStr == "edit"){
				...
				var rowIndex = 0;
				if(tblObj.rows != null && tblObj.rows != "undefined"){
				...
				$(newBlankRow).attr("ipType", $('#ipAddArea input[name=ipType]:checked').val());
				...
				*/
				...
				//newBlankCell.appendChild(document.createTextNode(ipVal));   
				//newBlankCell.innerText = ipVal;
				//newBlankRow.appendChild(newBlankCell);
			}
	...
	<div class="pop-m">
		<div class="pop-content">
			...
			<ul class="fieldlist-n">
				<li><span class="field">业务单位：</span><input type="text" id="bizName_txt" value=""/></li>
