...
<head>
  ...
  <style type="text/css"> 
    span.elli-name{width:145px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
    span.elli-profile{width:95px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
    span.elli-apptype{width:70px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
  ...
  <div class="padding8" >
    <ul>
      ...
      <li style="width:400px;" class="left">
        ...
        <select id="searchKey" name="searchKey" class="sb-line">
          ...
          <option value="PortIP" <s:if test="'PortIP'==searchKey">selected</s:if>><s:text name="detail.typical.portserveraddress" /></option>
          <option value="PortNo" <s:if test="'PortNo'==searchKey">selected</s:if>><s:text name="detail.typical.port" /> </option>
          <option value="PortType" <s:if test="'PortType'==searchKey">selected</s:if>><s:text name="detail.typical.apptype" /></option>
        </select>
        <input type="text" style="height:20px;line-height:20px;" name="searchVal"  id="searchVal" value="<s:property value="searchVal" />" />
        <span class="ico ico-select" id="searchBtn" title="点击进行搜索"></span>
      </li>
    </ul>
    <table id="detailTab" class="tongji-grid table-width100 grayborder" style="border:1px solic #ccc;margin-top:5px;">
      <tr>
        ...
        <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.portserveraddress" /> </span></th>
        <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.port" /></span></th>
        <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.apptype" /></span></th>
        <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.stratgy" /></span></th>
        <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.currentstatus" /></span></th>
      ...
      <tr class="line" <s:if test="#idx.isEven()">style="background-color:#f2f2f2;"</s:if>>
        ...
        <td>
          <s:generator val="#dataMap['PortIP']['metricValue']" separator="," var="iplist"></s:generator>
          <s:generator val="#dataMap['PortIP']['metricValue']" separator="," var="iplist1"></s:generator>
          ...
          <s:if test="#iplistSize == 1">
            <s:property value="#dataMap['PortIP']['metricValue']" default="-" />
          </s:if>
        ...
        <td><s:property value="#dataMap['PortNo']['metricValue']" default="-" /></td>
        <td><span class="elli-apptype" title="<s:property value="#dataMap['PortType']['metricValue']" default="-" />"><s:property value="#dataMap['PortType']['metricValue']" default="-" /></span></td>
        ...
        <td><span id="currentState_<s:property value="#dataMap['instanceId']" />" class="" style="cursor:default;">&nbsp;&nbsp;</span><span class="gray-btn-l" name="statBtn" id="<s:property value="#dataMap['instanceId']" />"><span class="btn-r"><span class="btn-m"><a style="font-size:10px;"><s:text name="detail.typical.detection" /></a></span></span></span></td>
        ...
        <s:bean name="org.apache.struts2.util.Counter" id="counter">
          ...
          <s:iterator>
            <tr class="line" <s:if test="current%2==0">style="background-color:#f2f2f2;"</s:if>>
              <td style="height:21px;">&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
            </tr>
          </s:iterator>
        </s:bean>
      </s:if>
