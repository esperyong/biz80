...
<s:form id="res-list-query">
	...
	<page:applyDecorator name="indexcirgrid"> 
		<page:param name="id">other_distribute_table</page:param>
		...
		<page:param name="gridhead">[{colId:"resInstanceId", text:"<input type='checkbox' name='all_instance' id='all_instance'/>"},{colId:"resInstanceName",text:"名称"}]</page:param>
...
$(document).ready(function(){
	var gp = new GridPanel({id:"other_distribute_table",
		unit:"%",
		columnWidth:{resInstanceId:10,resInstanceName:90},
		plugins:[SortPluginIndex],
		sortColumns:[{index:"resInstanceName",defSorttype:"desc"}],
