...
<head>
  ...
  <style type="text/css"> 
    ...
    span.elli-profile{width:110px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
    span.elli-url{width:140px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
  ...
  <div class="padding8" >
    <ul>
      ...
      <li style="width:400px;" class="left">
        ...
        <select id="searchKey" name="searchKey" class="sb-line">
          ...
          <option value="StandardAppPort_adv" <s:if test="'StandardAppPort_adv'==searchKey">selected</s:if>><s:text name="detail.typical.port" /> </option>
          <option value="StandardAppURLIPAddress_adv" <s:if test="'StandardAppURLIPAddress_adv'==searchKey">selected</s:if>><s:text name="detail.typical.portserveraddress" /></option>
          <option value="StandardAppURLAddress_adv" <s:if test="'StandardAppURLAddress_adv'==searchKey">selected</s:if>><s:text name="detail.typical.urladdress" /></option>
        </select>
    ...
    <table id="detailTab" class="tongji-grid table-width100 grayborder" style="border:1px solic #ccc;margin-top:5px;">
      ...
      <tr class="line" <s:if test="#idx.isEven()">style="background-color:#f2f2f2;"</s:if>>
        ...
        <td><s:property value="#dataMap['StandardAppPort_adv']['metricValue']" default="-" /></td>
        <td>
          <s:generator val="#dataMap['StandardAppURLIPAddress_adv']['metricValue']" separator="," var="iplist"></s:generator>
          <s:generator val="#dataMap['StandardAppURLIPAddress_adv']['metricValue']" separator="," var="iplist1"></s:generator>
          ...
          <s:if test="#iplistSize == 1">
            <s:property value="#dataMap['StandardAppURLIPAddress_adv']['metricValue']" default="-" />
          </s:if>
        ...
        <td><span class="elli-url" title="<s:property value="#dataMap['StandardAppURLAddress_adv']['metricValue']" default="-" />"><s:property value="#dataMap['StandardAppURLAddress_adv']['metricValue']" default="-" /></span></td>
