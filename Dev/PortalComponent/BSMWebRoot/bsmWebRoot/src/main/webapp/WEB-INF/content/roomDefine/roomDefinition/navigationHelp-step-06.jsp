...
<body >
<div class="fold-blue">
	<div class="fold-top bold">第六步：设置告警规则态</div>
</div>
          ...
          <table width="100%" cellspacing="0" cellpadding="0">
            <tr>
              <td width="100%" align="center" valign="top"><table width="99%" cellpadding="6" cellspacing="0">
                  <tr>
                    ...
                    <td width="100%" align="left">
	                    <ul>
	                  	<li></li>
	                  	<li>
                    	在‘监控设置->告警定义’页面设置机房监控指标异常时的告警规则。
                    	</li>
                    	<li>
                    	</li>
                    </ul>
                  ...
                  <tr>
                    <td align="left" valign="top"><img src="${ctx}/flash/pic/guide/guide-step-06-pic-01.jpg" width="667" height="227" /></td>
                  </tr>
                </table>
                </td>
            </tr>
