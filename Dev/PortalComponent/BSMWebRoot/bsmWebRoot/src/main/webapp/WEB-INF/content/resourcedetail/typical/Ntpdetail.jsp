...
<head>
  ...
  <style type="text/css"> 
    ...
    span.elli-profile{width:70px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
    span.elli-time1{width:100px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
    span.elli-time2{width:95px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
    span.elli-time3{width:60px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
    span.elli-time4{width:90px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
  ...
  <!-- content start -->
    ...
    <ul>
			...
			<li style="width:400px;" class="left">
			  ...
			  <select id="searchKey" name="searchKey" class="sb-line"><option value="name" <s:if test="'name'==searchKey">selected</s:if>><s:text name="detail.typical.displayname" /></option><option value="NTPServerHostIP_base" <s:if test="'NTPServerHostIP_base'==searchKey">selected</s:if>><s:text name="detail.info.ip" /></option></select>
		...
		<table id="detailTab" class="tongji-grid table-width100 grayborder" style="border:1px solic #ccc;margin-top:5px;">
			<tr>
			  ...
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.info.ip" /></span></th>
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.stratgy" /></span></th>
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.NTPServerPerTime_base" /></span></th>
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.NTPServerTimeSource" /></span></th>
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.NTPServerTime" /></span></th>
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.NTPServerUptime" /></span></th>
      ...
      <tr class="line" <s:if test="#idx.isEven()">style="background-color:#f2f2f2;"</s:if>>
        ...
        <td>
	        <s:generator val="#dataMap['NTPServerHostIP_base']['metricValue']" separator="," var="iplist"></s:generator>
	        <s:generator val="#dataMap['NTPServerHostIP_base']['metricValue']" separator="," var="iplist1"></s:generator>
	        ...
	        <s:if test="#iplistSize == 1">
	          <s:property value="#dataMap['NTPServerHostIP_base']['metricValue']" default="-" />
	        </s:if>
        ...
        <td><span class="elli-time1" title="<s:property value="#dataMap['NTPServerPerTime_base']['metricValue']" default="-" />"><s:property value="#dataMap['NTPServerPerTime_base']['metricValue']" default="-" /></span></td>
        <td><span class="elli-time2" title="<s:property value="#dataMap['NTPServerTimeSource_base']['metricValue']" default="-" />"><s:property value="#dataMap['NTPServerTimeSource_base']['metricValue']" default="-" /></span></td>
        <td><span class="elli-time3" title="<s:property value="#dataMap['NTPServerTime_base']['metricValue']" default="-" />"><s:property value="#dataMap['NTPServerTime_base']['metricValue']" default="-" /></span></td>
        <td><span class="elli-time4" title="<s:property value="#dataMap['NTPServerUptime_base']['metricValue']" default="-" />"><s:property value="#dataMap['NTPServerUptime_base']['metricValue']" default="-" /></span></td>
        ...
        <s:bean name="org.apache.struts2.util.Counter" id="counter">
          ...
          <s:iterator>
			      <tr class="line" <s:if test="current%2==0">style="background-color:#f2f2f2;"</s:if>>
			        <td style="height:21px;">&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
			      </tr>
          </s:iterator>
        </s:bean>
      </s:if>
