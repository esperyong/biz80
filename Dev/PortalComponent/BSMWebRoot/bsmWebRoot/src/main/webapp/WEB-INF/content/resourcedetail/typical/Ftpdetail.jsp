...
<head>
  ...
  <style type="text/css"> 
    span.elli-name{width:170px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
    span.elli-profile{width:120px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
  ...
  <div class="padding8" >
    <ul>
      ...
      <li style="width:400px;" class="left">
        ...
        <select id="searchKey" name="searchKey" class="sb-line"><option value="name" <s:if test="'name'==searchKey">selected</s:if>><s:text name="detail.typical.displayname" /></option><option value="FtpIPAddress" <s:if test="'FtpIPAddress'==searchKey">selected</s:if>><s:text name="detail.typical.ftpserveraddress" /></option></select>
    ...
    <table id="detailTab" class="tongji-grid table-width100 grayborder" style="border:1px solic #ccc;margin-top:5px;">
      <tr>
        ...
        <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.ftpserveraddress" /></span></th>
        <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.stratgy" /></span></th>
        <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.UpRate" /></span></th>
        <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.DownRate" /></span></th>
      ...
      <tr class="line" <s:if test="#idx.isEven()">style="background-color:#f2f2f2;"</s:if>>
        ...
        <td>
          <s:generator val="#dataMap['FtpIPAddress']['metricValue']" separator="," var="iplist"></s:generator>
          <s:generator val="#dataMap['FtpIPAddress']['metricValue']" separator="," var="iplist1"></s:generator>
          ...
          <s:if test="#iplistSize == 1">
            <s:property value="#dataMap['FtpIPAddress']['metricValue']" default="-" />
          </s:if>
        ...
        <td><s:property value="#dataMap['UpRate']['metricValue']" default="-" /></td>
        <td><s:property value="#dataMap['DownRate']['metricValue']" default="-" /></td>
