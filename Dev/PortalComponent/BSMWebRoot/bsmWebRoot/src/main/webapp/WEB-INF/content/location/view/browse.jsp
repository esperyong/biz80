<!-- WEB-INF\content\location\view\browse.jsp -->
...
<style type="text/css">
.phy-mid-m{ background:url(../images/table/Physical-location-contentbg.png) 0 0 repeat; height:500px; margin-right:9px; position:relative;}
</style>
...
<div class="physical-location" style="height: 100%">
  ...
  <div class="phy-mid-l">
    <div class="phy-mid-r">
      <div class="phy-mid-m" style="height:645px;">
	  <!--左边菜单开始，关闭样式：class="phy-menu-close"-->
		...
		<div class="phy-rightmenu-open" id="phy-rightmenu">
          <ul class="line">
            ...
            <li class="title">关联的内容</li>
          </ul>
          <div id="relationContent"></div>
        </div>	
		<!--    右边菜单结   束-->
		<!-- 普通物理位置 2D falsh 开始-->
		<div id="locationContainer_t">
		<div id="locationContent" style="z-index: 112; display: none">
...
<b style="font-size:16px;">  和机房的关联</b> 
  ...
  物理位置中快速验证。
		...
		<div id="roomNoLicense" style="height: 100%;display: none;">
			<span>
				无关联机房的License，请联络摩卡软件获取购买相关License的信息。
			</span>
		</div>
		<!-- 机房  结束-->
      </div>
...
// 重新物理位置的内容
function refreshModel(roomLicense){
