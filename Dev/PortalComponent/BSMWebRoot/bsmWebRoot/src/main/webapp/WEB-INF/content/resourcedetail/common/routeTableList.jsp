...
<body>
<form name="routeListForm" id="routeListForm" method="post">
<input type="hidden" name="instanceId" id="instanceId" value="${instanceId}"/>
<page:applyDecorator name="popwindow">
 <page:param name="title"><s:text name="routertable" /></page:param>
 ...
 <div>
 <span class="title"><s:text name="detail.data.coltime" /></span><s:property value="time" default="-" /><span class="title"><s:text name="detail.arptable.note" /></span>
 </div>
...
<script src="${ctx}/js/resourcedetail/routeTableListChild.js"></script>
</page:param>
</page:applyDecorator>
</form>
</body>
