...
<head>
  ...
  <style type="text/css"> 
    span.elli-name{width:125px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
    span.elli-profile{width:85px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
    span.elli-url{width:145px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
    ...
    <ul>
			...
			<li style="width:400px;" class="left">
			  ...
			  <select id="searchKey" name="searchKey" class="sb-line">
				  ...
				  <option value="URLAddress" <s:if test="'URLAddress'==searchKey">selected</s:if>><s:text name="detail.typical.urladdress" /></option>
			  </select>
		...
		<table id="detailTab" class="tongji-grid table-width100 grayborder" style="border:1px solic #ccc;margin-top:5px;">
			<tr>
			  ...
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.tracename" /><!-- <a class="theadbar-ico theadbar-ico-up" href="#"></a><a class="theadbar-ico theadbar-ico-down" href="#"></a> --></span></th>
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.urladdress" /></span></th>
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.stratgy" /></span></th>
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.HTTPReturnCode" /></span></th>
      ...
      <tr class="line" <s:if test="#idx.isEven()">style="background-color:#f2f2f2;"</s:if>>
        ...
        <td><span class="elli-url" title="<s:property value="#dataMap['URLAddress']['metricValue']" default="-" />">
          <s:property value="#dataMap['URLAddress']['metricValue']" default="-" />
          </span>
        </td>
        ...
        <td><s:property value="#dataMap['HTTPReturnCode']['metricValue']" default="-" /></td>
        <td><s:property value="#dataMap['URLResponseTime']['metricValue']" default="-" /></td>
