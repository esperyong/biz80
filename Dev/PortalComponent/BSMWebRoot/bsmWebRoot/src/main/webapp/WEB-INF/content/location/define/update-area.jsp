<!-- WEB-INF\content\location\define\update-area.jsp -->
...
<s:if test="#request.succeed == true">
	...
	$(document).ready(function() {
		...
		$.validationEngineLanguage.allRules.duplicateLocationName = {
		  "file":"${ctx}/location/locationcheck!checkLocationName.action",
		  "alertTextLoad":"* 正在验证，请等待",
		  "alertText":"* 同级区域／子区域名称重复"
	}
	...
	<s:hidden name="location.type" />
		<ul class="fieldlist-n">
			<li><span class="field">区域名称：</span>
				<s:textfield name="location.name" cssClass="validate[required,length[0,30],ajax[duplicateLocationName]]"></s:textfield><span class="red">*</span></li>
			<li><span class="field">备注：</span>
				<s:textarea name="location.remarks" cssClass="validate[required,length[0,200],custom[noSpecialStr]]" ></s:textarea>
			</li>
		</ul>
	</s:form>
	</page:param>
