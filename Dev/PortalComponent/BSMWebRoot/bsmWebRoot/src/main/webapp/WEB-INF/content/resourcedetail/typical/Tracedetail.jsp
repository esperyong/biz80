...
<head>
  ...
  <style type="text/css"> 
    ...
    span.elli-response{width:90px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
  </style>
  ...
  <!-- content start -->
    ...
    <ul>
      ...
      <li style="width:400px;" class="left">
        <span class="suojin1em bold"><s:text name="detail.typical.tracename" /><s:text name="i18n.colon" /></span><input type="text" name="searchVal" id="searchVal" value="<s:property value="searchVal" />" /><input type="hidden" value="name" />
		...
		<table id="detailTab" class="tongji-grid table-width100 grayborder" style="border:1px solic #ccc;margin-top:5px;">
			<tr>
			  ...
			  <th rowspan="2" style="text-align:center;"><nobr><span><s:text name="detail.typical.tracename" /><!-- <a class="theadbar-ico theadbar-ico-up" href="#"></a><a class="theadbar-ico theadbar-ico-down" href="#"></a> --></span></nobr></th>
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.TargetIPAddress" /></span></th>
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.StandbyIPAddress" /></span></th>
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.stratgy" /></span></th>
			  <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.NetworkNodeResponseTime" /></span></th>
      ...
      <tr class="line" <s:if test="#idx.isEven()">style="background-color:#f2f2f2;"</s:if>>
        ...
        <td>
          <s:generator val="#dataMap['TargetIPAddress']['metricValue']" separator="," var="iplist"></s:generator>
          <s:generator val="#dataMap['TargetIPAddress']['metricValue']" separator="," var="iplist1"></s:generator>
          ...
          <s:if test="#iplistSize == 1">
            <s:property value="#dataMap['TargetIPAddress']['metricValue']" default="-" />
          </s:if>
        ...
        <td>
          <s:generator val="#dataMap['StandbyIPAddress']['metricValue']" separator="," var="iplist"></s:generator>
          <s:generator val="#dataMap['StandbyIPAddress']['metricValue']" separator="," var="iplist1"></s:generator>
          <s:iterator value="#iplist" status="st">
            <s:if test="%{#st.last}">
              <s:set name="iplistSize" value="%{#st.count}"></s:set>
            </s:if>
          ...
          <s:if test="#iplistSize == 1">
            <s:property value="#dataMap['StandbyIPAddress']['metricValue']" default="-" />
          </s:if>
          <s:elseif test="#iplistSize > 1">
            <select id="ipsel_<s:property value="#dataMap['instanceId']" />">
              <s:iterator value="#iplist1">
        ...
        <td><span class="elli-response" title="<s:property value="#dataMap['TraceResponseTime']['metricValue']" default="-" />"><s:property value="#dataMap['TraceResponseTime']['metricValue']" default="-" /></span></td>
