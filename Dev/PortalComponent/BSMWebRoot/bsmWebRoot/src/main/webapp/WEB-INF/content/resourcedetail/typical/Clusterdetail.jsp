  ...
  <div class="padding8">
    <ul>
      ...
      <li style="width:400px;" class="left">
        <span class="suojin1em bold"><s:text name="detail.typical.clustername" /><s:text name="i18n.colon" /></span><input type="text" name="searchVal" id="searchVal" value="<s:property value="searchVal" />" /><input type="hidden" value="name" />
    ...
    <table id="detailTab" class="tongji-grid table-width100 grayborder" style="border:1px solic #ccc;margin-top:5px;">
      <tr>
        ...
        <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.clustername" /><!-- <a class="theadbar-ico theadbar-ico-up" href="#"></a><a class="theadbar-ico theadbar-ico-down" href="#"></a> --></span></th>
        <th rowspan="2" style="text-align:center;"><span><s:text name="detail.typical.clusternode" /> </span></th>
      ...
      <tr class="line" <s:if test="#idx.isEven()">style="background-color:#f2f2f2;"</s:if>>
        ...
        <td>
          <s:iterator value="#dataMap['childList']" var="childMap" status="idx">
            <span class="<s:property value="#childMap['childState']" />" name="childState" childId="<s:property value="#childMap['childId']" />" title="<s:text name="detail.typical.node" /><s:text name="i18n.colon" /><s:property value="#childMap['childId']" />"></span>
          </s:iterator>
        </td>
        <td>
