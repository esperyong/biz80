...
<head>
  ...
  <style type="text/css"> 
    ...
    span.elli-profile{width:140px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden; word-spacing:normal; word-break:normal; display:block;}
  ...
  <!-- content start -->
    ...
    <ul>
			...
			<li style="width:400px;" class="left">
			  ...
			  <select id="searchKey" name="searchKey" class="sb-line"><option value="name" <s:if test="'name'==searchKey">selected</s:if>><s:text name="detail.typical.displayname" /></option><option value="NetworkNodeIPAddress" <s:if test="'NetworkNodeIPAddress'==searchKey">selected</s:if>><s:text name="detail.info.ip" /></option></select>
      ...
      <tr class="line" <s:if test="#idx.isEven()">style="background-color:#f2f2f2;"</s:if>>
        ...
        <td>
          <s:generator val="#dataMap['NetworkNodeIPAddress']['metricValue']" separator="," var="iplist"></s:generator>
          <s:generator val="#dataMap['NetworkNodeIPAddress']['metricValue']" separator="," var="iplist1"></s:generator>
          ...
          <s:if test="#iplistSize == 1">
            <s:property value="#dataMap['NetworkNodeIPAddress']['metricValue']" default="-" />
          </s:if>
        ...
        <td><s:property value="#dataMap['NetworkNodeResponseTime']['metricValue']" default="-" /></td>
