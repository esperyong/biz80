...
<body>
<page:applyDecorator name="popwindow"  title="编辑平台">
	...
	<UL class="fieldlist-n">
		<li>
			<span class="field">平台名称：</span><s:hidden name="platForm.platFormId" id="platFormId"/><s:hidden name="platForm.switchSet"/><s:textfield name="platForm.platFormName" size="35" cssClass="validate[required,noSpecialStr,length[0,30],ajax[duplicatePlatFormName]]"/><span class="red">*</span>
		</li>
		<li>
			<span class="field">关键字：</span><s:textfield name="platForm.keyWord" size="35" cssClass="validate[required,noSpecialStr,length[0,30],ajax[duplicateKeyWord]]"/><span class="red">*</span>
		</li>
		<li>
			<span class="field">所属<s:property value="@com.mocha.bsm.event.common.RangeName@rangeName()"/>：</span><s:select id="userDomainIds" list="userDomains" name="userDomains" listKey="key" listValue="value" multiple="true" cssClass="validate[funcCall[userDomainSelect]]" cssStyle="width:210px; height:120px" /><span class="red">*</span><span class="ico ico-find"></span>
		</li>
	</UL>
	</s:form>
	</page:param>
...
$(document).ready(function(){
	...
	$.validationEngineLanguage.allRules.duplicatePlatFormName = {
		  "file":"${ctx}/event/duplicateValidate!validatePlatFormName.action?platFormId="+$("#platFormId").val(),
		  "alertTextLoad":"* 正在验证，请等待",
		  "alertText":"* 有重复的平台名称"
	}
	$.validationEngineLanguage.allRules.duplicateKeyWord = {
		  "file":"${ctx}/event/duplicateValidate!validateKeyWord.action?platFormId="+$("#platFormId").val(),
		  "alertTextLoad":"* 正在验证，请等待",
		  "alertText":"* 有重复的关键字"
	}
...
function openViewPage(panel,url,title) {
	...
	listeners:{closeAfter:function(){panel = null;},loadAfter:function(){}}},{winpanel_DomStruFn:"pop_winpanel_DomStruFn"}); 
}
...
function submitForm() {
	...
	$.ajax({
		type: "POST",
		dataType:'html',
		url: "${ctx}/event/platFormSet!updatePlatForm.action",
		data: ajaxParam,
