...
$(document).ready(function(){
	$.get('${ctx}<%=contentURI%>',{},function(data){
		...
		*/
		...
		var treeview = new JDynamicTreeview({id:"bizServiceTree", lineStyle:"treeview-black", animated:300, collapsed:true, unique: false});
		...
		$subBizNodes.each(function(i){
			...
			treeview.addTreeNode(nodeMap, true, {runState:runStateStr}, function(dataMap){
				//设置当前业务服务运行状态
				parent.currentServiceRunState = treeview.getUserData(dataMap["nodeID"], "runState");
