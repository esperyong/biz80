...
<body>
<form name="arpListForm" id="arpListForm" method="post">
<input type="hidden" name="instanceId" id="instanceId" value="${instanceId}"/>
<page:applyDecorator name="popwindow"  title="ARP">
...
<script src="${ctx}/js/resourcedetail/arpTableListChild.js"></script>
</page:param>
</page:applyDecorator>
</form>
</body>
