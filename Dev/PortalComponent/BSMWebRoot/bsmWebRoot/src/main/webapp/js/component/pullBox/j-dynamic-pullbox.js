...
function default_JDynamicPullPanel_DomStruFn(conf){
	...
	this.panelObj.append('<div elID="jPullboxPanel" class="content-right"><div elID="jPullboxLeftHandle" class="content-set-open"><div elID="jPullboxlArrowHot" class="set-button"></div><div elID="jPullboxContentPanel" class="set-content"></div></div></div>');
